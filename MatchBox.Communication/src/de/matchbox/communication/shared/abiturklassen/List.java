 ...
 * einen Auftrag zum aktuellen Objekt gemacht werden. Au�erdem kann das dem
 ...
 * kann vor dem aktuellen Objekt ein Listenobjekt eingef�gt werden.</p>
 *
 * <p>
 * NW-Arbeitsgruppe: Materialentwicklung zum Zentralabitur im Fach
 * Informatik</p>
 *
 * @version 2011-03-31
 */
public class List {
     ...
     * Ausf�hrung des Auftrags kein aktuelles Objekt, d.h. hasAccess() liefert
     * den Wert false.
     */
    public void next() {
        if (this.hasAccess()) {
    ...
    public Object getNextObject() {
        if (this.hasAccess()) {
            return current.getNext().content();
        } else {
            return null;
        }
    }
    ...
    /**
     * Falls es ein aktuelles Objekt gibt (hasAccess() == true), wird das
     * aktuelle Objekt geloescht und das Objekt hinter dem gelaeschten Objekt
